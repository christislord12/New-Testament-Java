...
/*c*/var C$=Clazz.newClass(P$, "NewTestament", null, 'javax.swing.JFrame', 'java.awt.event.ItemListener');
...
C$.c2.setPreferredSize$java_awt_Dimension(Clazz.new_($I$(4,1).c$$I$I,[300, 100]));
C$.c2.setFont$java_awt_Font(Clazz.new_($I$(5,1).c$$S$I$I,["Serif", 0, 35]));
...
var imageIcon=Clazz.new_([Clazz.new_([Clazz.getClass(C$).getResource$S("NewTestament1.JPG")],$I$(9,1).c$$java_net_URL).getImage$()],$I$(9,1).c$$java_awt_Image);
C$.l3.setIcon$javax_swing_Icon(imageIcon);
C$.f.getContentPane$().add$java_awt_Component(C$.l3);
C$.f.pack$();
C$.f.setSize$I$I(1800, 2500);
C$.f.show$();
}, 1);
...
;Clazz.setTVer('3.3.1-v5');//Created 2023-01-07 20:24:34 Java2ScriptVisitor version 3.3.1-v5 net.sf.j2s.core.jar version 3.3.1-v5
