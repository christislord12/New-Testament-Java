...
class NewTestament extends JFrame implements ItemListener {
	...
	public static void main(String[] args)
	{
		...
		ImageIcon imageIcon = new ImageIcon(new ImageIcon(NewTestament.class.getResource("NewTestament1.JPG")).getImage().getScaledInstance(560, 750, Image.SCALE_SMOOTH));
